   ...
   <body>
      <div>
         ...
         <div class="flex flex-row justify-center">
            <table class="w-80 text-center table-bordered">
               <tbody>
            ...
            <form action="/game/session" method="post">
               @csrf
               <button type="submit" class="btn btn-spin">Spin Me</button>
            </form>
         </div>
         <div class="flex flex-row justify-center padding-top-20">
            <form action="/game/session/end" method="post">
               @csrf
               <button type="submit" class="btn btn-cash">Cash Out</button>
            </form>
         </div>
      </div>
   </body>
